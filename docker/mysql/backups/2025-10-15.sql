...
INSERT INTO `game_status` VALUES (1,2,'2025-10-15 21:07:32');
...
INSERT INTO `hint` VALUES (1,'albumCover'),(8,'albumName'),(2,'artistName'),(4,'audio'),(6,'musicVideo10Seconds'),(9,'releaseYear'),(10,'revealLetter'),(7,'revealVowels');
...
INSERT INTO `picker` VALUES (1,'Elias','Böhm'),(3,'test','test');
...
INSERT INTO `song` VALUES (1,'Beat it','Michael Jackson',0,1,'test.mp3',NULL,NULL,NULL,NULL),(2,'Pink + White','Frank Ocean',0,1,'pink_white.mp3','https://www.youtube.com/embed/SXHpcYneDeM','Blonde','blonde.jpg',2016),(3,'White Ferrari','Frank Ocean',0,1,'test.mp3',NULL,NULL,'blonde.jpg',NULL),(4,'test','test',0,NULL,'test','test','test','test',1000),(5,'Elias','elias',0,NULL,'elias','elias','elias','elias',23);
...
INSERT INTO `song_hint` VALUES (2,2,4,5,NULL),(3,2,1,1,NULL),(4,2,9,2,NULL),(5,2,2,4,NULL),(6,2,7,3,NULL);
...
-- Dump completed on 2025-10-15 22:51:49
